class OwnersController < ApplicationController
  ...
  def order_history_owners
    ...
    @orders.each do |order|
      order.order_items.each do |order_item|
        owner = order_item.owner_offer.owner #  OrderItems belongs_to :business_offer  & BusinessOffers belongs_to :business
  ...
  def owner_params
    params.require(:owner).permit(:name, :address, :instagram, :website, :photo, :description, :category_id)
  end
